...
class CafeRestaurantsScreen extends StatefulWidget {
  CafeRestaurantsScreen({Key? key}) : super(key: key);

  @override
  State<CafeRestaurantsScreen> createState() => _CafeRestaurantsScreenState();
}

class _CafeRestaurantsScreenState extends State<CafeRestaurantsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final restaurants = _restaurantsData.cafeRestaurants;
